        ...
        $html = "
            <tr>
            <td><a class='btn' href='LietKeSP_ajax.php'><i class='fal fa-angle-left'></i> Tiếp tục mua hàng</a></td>
            <td colspan='2'>Tổng tiền:<span id='totalPrice'></span>đ</td>
            <td><a class='btn btnThanhtoan' href='thanhtoan.html' style='background-color:rgb(4,170,109)'>Thanh Toán</a></td>
            </tr>
              ";
        echo $html;
    }
